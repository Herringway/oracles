module oracles.common.objects.items.postUpdate;
...
//; ITEM_MAGNET_GLOVES
//;
void itemCode08Post(GameObject* item) {
	assert(0, "NYI");
...
//; ITEM_SLINGSHOT
//;
void itemCode13Post(GameObject* item) {
	assert(0, "NYI");
//	call cpRelatedObject1ID
//	jp nz,itemDelete
...
//; ITEM_FOOLS_ORE
//;
void itemCode1EPost(GameObject* item) {
	assert(0, "NYI");
//	call cpRelatedObject1ID
//	jp nz,itemDelete
...
//; ITEM_PUNCH
//;
alias itemCode02Post = itemCode00Post;
void itemCode00Post(GameObject* item) {
	assert(0, "NYI");
//	ld a,(w1Link.direction)
//	add $18
//	ld hl,swordArcData
...
//; ITEM_BIGGORON_SWORD
//;
void itemCode0CPost(GameObject* item) {
	assert(0, "NYI");
//	call cpRelatedObject1ID
//	jp nz,itemDelete
...
//; ITEM_ROD_OF_SEASONS
//;
alias itemCode05Post = itemCode04Post;
alias itemCode07Post = itemCode04Post;
void itemCode04Post(GameObject* item) {
	assert(0, "NYI");
//	call cpRelatedObject1ID
//	jp nz,itemDelete
