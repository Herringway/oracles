module oracles.common.objects.special.common;
...
struct SpecialOAMData {
	ubyte tile;
	ubyte flags;
}
//; Initializes SpecialObject.oamFlags and SpecialObject.oamTileIndexBase, according to the id of the object.
//; @param	d	Object
void specialObjectSetOAMVariables(GameObject* object) {
	static immutable SpecialOAMData[] data = [
		SpecialObject.link: SpecialOAMData(0x70, 0x08),
		SpecialObject.unnamed01: SpecialOAMData(0x70, 0x08),
		SpecialObject.linkAsBaby: SpecialOAMData(0x70, 0x08),
		SpecialObject.linkAsSubrosian: SpecialOAMData(0x70, 0x08),
		SpecialObject.linkAsRetro: SpecialOAMData(0x70, 0x08),
		SpecialObject.linkAsOctorok: SpecialOAMData(0x70, 0x08),
		SpecialObject.linkAsMoblin: SpecialOAMData(0x70, 0x08),
		SpecialObject.linkAsLikeLike: SpecialOAMData(0x70, 0x08),
		SpecialObject.linkCutscene: SpecialOAMData(0x70, 0x08),
		SpecialObject.linkRidingAnimal: SpecialOAMData(0x70, 0x08),
		SpecialObject.minecart: SpecialOAMData(0x60, 0x0C),
		SpecialObject.ricky: SpecialOAMData(0x60, 0x0B),
		SpecialObject.dimitri: SpecialOAMData(0x60, 0x0A),
		SpecialObject.moosh: SpecialOAMData(0x60, 0x09),
		SpecialObject.maple: SpecialOAMData(0x60, 0x08),
		SpecialObject.rickyCutscene: SpecialOAMData(0x60, 0x0B),
		SpecialObject.dimitriCutscene: SpecialOAMData(0x60, 0x0A),
		SpecialObject.mooshCutscene: SpecialOAMData(0x60, 0x09),
		SpecialObject.mapleCutscene: SpecialOAMData(0x60, 0x08),
		SpecialObject.raft: SpecialOAMData(0x60, 0x0B),
	];
	object.var32 = 0xFF;
	object.oamTileIndexBase = data[object.id].tile;
	object.oamFlagsBackup = object.oamFlags = data[object.id].flags;
}
...
void updateLinkInvincibilityCounter() {
	if (link.invincibilityCounter == 0) {
		return;
	}
	if (link.invincibilityCounter >= 0x80) {
		link.invincibilityCounter++;
	} else {
		if ((--link.invincibilityCounter != 0) && ((frameCounter & 4) == 0)) {
			link.oamFlags = 0b00001101;
			return;
		}
	}
	link.oamFlags = link.oamFlagsBackup;
}
