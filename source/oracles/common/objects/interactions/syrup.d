module oracles.common.objects.interactions.syrup;
...
static if (gameVersion == GameVersion.ages) {
	void interactionCode5F(GameObject* obj) {
	//	callab commonInteractions2.checkReloadShopItemTiles
		interactCommon(obj);
	}
} else {
	void interactionCode43(GameObject* obj) {
	//	call commonInteractions2.checkReloadShopItemTiles
		interactCommon(obj);
	}
}
void interactCommon(GameObject* obj) {
//	call @runState
