module oracles.common.objects.interactions.syrupCucco;
...
static if (gameVersion == GameVersion.ages) {
	alias interactionCodeC9 = interactionCode;
} else {
	alias interactionCode49 = interactionCode;
}
void interactionCode(GameObject* obj) {
//	call @runState
//	jp @updateAnimation
	assert(0, "NYI");
}
