module oracles.common.objects.itemParents.commonCode;
...
void setLinkUsingItem1(GameObject* object) {
//	call itemIndexToBit
//	swap a
//	or (hl)
...
void clearLinkUsingItem1(GameObject* object) {
	ubyte bits = itemIndexToBit(object);
	bits |= swap(bits);
//	swap a
//	or (hl)
//	cpl
...
void itemEnableLinkMovement(GameObject* object) {
//	call itemIndexToBit
//	ld hl,wLinkImmobilized
//	cpl
//	and (hl)
...
void itemDisableLinkTurning(GameObject* object) {
//	call itemIndexToBit
...
void itemEnableLinkTurning(GameObject* object) {
//	call itemIndexToBit
//	ld hl,wLinkTurningDisabled
//	cpl
//	and (hl)
...
ubyte itemIndexToBit(GameObject* object) {
	assert((object >= &itemObjects[2]) && (object < &itemObjects[10]));
	return cast(ubyte)((1 << (object - &itemObjects[2])));
}
