module oracles.ages.objects.items.switchHook;
...
void itemCode0BPost(GameObject* item) {
	assert(0, "NYI");
...
//;;
//; ITEM_SWITCH_HOOK_CHAIN
void itemCode0B(GameObject* item) {
	assert(0, "NYI");
//	ld e,Item.state
//	ld a,(de)
//	or a
...
//;;
//; ITEM_SWITCH_HOOK
void itemCode0APost(GameObject* item) {
	assert(0, "NYI");
...
//;;
//; ITEM_SWITCH_HOOK
void itemCode0A(GameObject* item) {
	assert(0, "NYI");
//	ld a,$08
...
void itemCode09(GameObject* item) {
	assert(0, "NYI");
//	ld h,d
//	ld l,Item.var2f
//	bit 5,(hl)
